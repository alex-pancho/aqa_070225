...
while True:
    ...
    if pizza_topping == "quit":
        break
    print(f"Ми додамо цю начинку до піци: {pizza_topping}")
...
for number in range(max_guesses):
    ...
    if guess < secret_number:
        ...
        print(f"Вітаю! Ви вгадали число {secret_number} за {guesses} спроб")
        break
else:
    print(f"Ви не вгадали число {secret_number} за {max_guesses} спроб")
