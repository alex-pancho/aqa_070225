...
#
#
# account = BankAccount("Оля", 500)
#
# # доступ до балансу напряму
# print(account.balance)  # Виведе: 500

class BankAccount:
    def __init__(self, owner, balance):
        self.owner = owner
        self.__balance = balance  # ← тепер це інкапсульоване (приватне) поле

# створюємо об'єкт
account = BankAccount("Оля", 500)

# доступ до балансу напряму
print(account.__balance)  # Виведе: 500