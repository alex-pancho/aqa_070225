...
if __name__ == "__main__":
    student = Student("John", "Week", 30, 10.5)

    print(f"Student name: {student.get_name()}, surname: {student.get_surname()}, age: {student.get_age()}, "
          f"grades: {student.get_grades()}")
    student.set_grades(9.8) # change grades
    print(f"Student name: {student.get_name()}, surname: {student.get_surname()}, age: {student.get_age()}, "
          f"grades: {student.get_grades()}")