...
def validate_json(folderpath: Path) -> None:
    # Вказуємо повний шлях до файлу логу в поточній директорії
    log_file = Path(__file__).parent / 'json_bykov.log'
    logger = create_logger(log_filename=log_file, log_level=logging.ERROR)
...
if __name__ == "__main__":
    ...
    result_csv = Path(__file__).parent / "result_bykov.csv"
